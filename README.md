...
> **運用手順(プロファイルの更新、通知閾値の変更、トラブルシューティング)は
> [Confluence の運用マニュアル](https://skart.atlassian.net/wiki/spaces/~614aaf7cbe1de8006bd884ce/pages/33718278)
> にまとめてあります。** 以下はセットアップと設計の説明です。
